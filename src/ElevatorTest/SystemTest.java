...
public class SystemTest {
    ...
    public void setup() throws IOException {
        ...
        //create 4 elevators and their threads
        ...
        //create GUI and add all the elevators
        gui = new MainGUI();
        gui.addElevator(a);
        gui.addElevator(b);
        gui.addElevator(c);
    ...
    public void receiveAndSendRequests() throws InterruptedException {
        ...
        //infinite loop until all requests completed
        Thread.sleep(500);
        while(a.getState().getCurrentState() != "IDLE" || b.getState().getCurrentState() != "IDLE" 
        		|| c.getState().getCurrentState() != "IDLE" || d.getState().getCurrentState() != "IDLE" || floorThreadsFinished) {
